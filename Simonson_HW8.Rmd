...
- __Answer:__ The estimate for $\hat{\beta_0}$ is 55.76094; the estimate for $\hat{\beta_1}$ is 0.09878. The data provide strong evidence of a positive linear relationship; we observe a t-statistic for $\hat{\beta_1}$ of 3.449 on 14 degrees of freedom, with a p-value of 0.003912.

## (b)

Does the mean diversity vary linearly with log(area), or does a model that allows the mean diversity to follow some other pattern appear to fit the data better? Provide the hypotheses, test statistic and a p-value in addition to your conclusion.
