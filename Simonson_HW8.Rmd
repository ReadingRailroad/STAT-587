...
- __Answer:__ The estimate for $\hat{\beta_0}$ is 55.76094; the estimate for $\hat{\beta_1}$ is 0.09878. To test whether or not the data provide evidence of a positive linear relationship we observe a t-statistic for $\hat{\beta_1}$ of 3.449 on 14 degrees of freedom, with a p-value of 0.003912.
